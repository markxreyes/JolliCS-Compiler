    ...
    public abstract class SyntaxAnalyzer : Analyzer {
        ...
        public override void Enter(Node node) {
            ...
            case (int) SyntaxConstants.COM2:
                ...
                break;
            case (int) SyntaxConstants.PJOLLICS:
                EnterPjollics((Production) node);
                break;
            case (int) SyntaxConstants.PGLOBAL:
                EnterPglobal((Production) node);
                break;
            case (int) SyntaxConstants.PGLOBALC:
                EnterPglobalc((Production) node);
                break;
            case (int) SyntaxConstants.PVARDEC:
                EnterPvardec((Production) node);
                break;
            case (int) SyntaxConstants.PDTYPE:
                EnterPdtype((Production) node);
                break;
            case (int) SyntaxConstants.PIDENTI:
                EnterPidenti((Production) node);
                break;
            case (int) SyntaxConstants.PARRAY:
                EnterParray((Production) node);
                break;
            case (int) SyntaxConstants.PARRAY2:
                EnterParray2((Production) node);
                break;
            case (int) SyntaxConstants.PCTR:
                EnterPctr((Production) node);
                break;
            case (int) SyntaxConstants.PCTRCHOICE:
                EnterPctrchoice((Production) node);
                break;
            case (int) SyntaxConstants.PVARDECTAIL:
                EnterPvardectail((Production) node);
                break;
            case (int) SyntaxConstants.PVTCHOICE:
                EnterPvtchoice((Production) node);
                break;
            case (int) SyntaxConstants.PARRAYTAIL:
                EnterParraytail((Production) node);
                break;
            case (int) SyntaxConstants.PARRAYTAIL2:
                EnterParraytail2((Production) node);
                break;
            case (int) SyntaxConstants.PARRAYTAIL3:
                EnterParraytail3((Production) node);
                break;
            case (int) SyntaxConstants.PVALUE:
                EnterPvalue((Production) node);
                break;
            case (int) SyntaxConstants.PNUM:
                EnterPnum((Production) node);
                break;
            case (int) SyntaxConstants.PVALUETAIL:
                EnterPvaluetail((Production) node);
                break;
            case (int) SyntaxConstants.PCONSTDEC:
                EnterPconstdec((Production) node);
                break;
            case (int) SyntaxConstants.PCONSTDECTAIL:
                EnterPconstdectail((Production) node);
                break;
            case (int) SyntaxConstants.PCONSTVAL:
                EnterPconstval((Production) node);
                break;
            case (int) SyntaxConstants.PSTRUCT:
                EnterPstruct((Production) node);
                break;
            case (int) SyntaxConstants.PFUNCDEC:
                EnterPfuncdec((Production) node);
                break;
            case (int) SyntaxConstants.PFTYPE:
                EnterPftype((Production) node);
                break;
            case (int) SyntaxConstants.PPARAM:
                EnterPparam((Production) node);
                break;
            case (int) SyntaxConstants.PPARAMTAIL:
                EnterPparamtail((Production) node);
                break;
            case (int) SyntaxConstants.PBODY:
                EnterPbody((Production) node);
                break;
            case (int) SyntaxConstants.PBODYCHOICE:
                EnterPbodychoice((Production) node);
                break;
            case (int) SyntaxConstants.PMATHCHOICE:
                EnterPmathchoice((Production) node);
                break;
            case (int) SyntaxConstants.PCALLFUNC:
                EnterPcallfunc((Production) node);
                break;
            case (int) SyntaxConstants.PPASS:
                EnterPpass((Production) node);
                break;
            case (int) SyntaxConstants.PPASS1:
                EnterPpass1((Production) node);
                break;
            case (int) SyntaxConstants.PMATH:
                EnterPmath((Production) node);
                break;
            case (int) SyntaxConstants.PCALC:
                EnterPcalc((Production) node);
                break;
            case (int) SyntaxConstants.PMATHOP:
                EnterPmathop((Production) node);
                break;
            case (int) SyntaxConstants.PCALC1:
                EnterPcalc1((Production) node);
                break;
            case (int) SyntaxConstants.POP:
                EnterPop((Production) node);
                break;
            case (int) SyntaxConstants.PINCDEC:
                EnterPincdec((Production) node);
                break;
            case (int) SyntaxConstants.POP1:
                EnterPop1((Production) node);
                break;
            case (int) SyntaxConstants.PLOGICAL:
                EnterPlogical((Production) node);
                break;
            case (int) SyntaxConstants.PLOGICAL1:
                EnterPlogical1((Production) node);
                break;
            case (int) SyntaxConstants.PLOGICON:
                EnterPlogicon((Production) node);
                break;
            case (int) SyntaxConstants.PLOGICONTAIL:
                EnterPlogicontail((Production) node);
                break;
            case (int) SyntaxConstants.PCOND:
                EnterPcond((Production) node);
                break;
            case (int) SyntaxConstants.PCOMP:
                EnterPcomp((Production) node);
                break;
            case (int) SyntaxConstants.PVAL:
                EnterPval((Production) node);
                break;
            case (int) SyntaxConstants.PCEX:
                EnterPcex((Production) node);
                break;
            case (int) SyntaxConstants.PDINEIN:
                EnterPdinein((Production) node);
                break;
            case (int) SyntaxConstants.PIN:
                EnterPin((Production) node);
                break;
            case (int) SyntaxConstants.PTAKEOUT:
                EnterPtakeout((Production) node);
                break;
            case (int) SyntaxConstants.POUT:
                EnterPout((Production) node);
                break;
            case (int) SyntaxConstants.POUTTAIL:
                EnterPouttail((Production) node);
                break;
            case (int) SyntaxConstants.PPOPO:
                EnterPpopo((Production) node);
                break;
            case (int) SyntaxConstants.PINITIAL:
                EnterPinitial((Production) node);
                break;
            case (int) SyntaxConstants.PFRENCHFRIES:
                EnterPfrenchfries((Production) node);
                break;
            case (int) SyntaxConstants.PCHICKENJOY:
                EnterPchickenjoy((Production) node);
                break;
            case (int) SyntaxConstants.PJOY:
                EnterPjoy((Production) node);
                break;
            case (int) SyntaxConstants.PJOY1:
                EnterPjoy1((Production) node);
                break;
            case (int) SyntaxConstants.PCHOICE:
                EnterPchoice((Production) node);
                break;
            case (int) SyntaxConstants.PYUM:
                EnterPyum((Production) node);
                break;
            case (int) SyntaxConstants.PICECREAM:
                EnterPicecream((Production) node);
                break;
            case (int) SyntaxConstants.PICE:
                EnterPice((Production) node);
                break;
            case (int) SyntaxConstants.PCONDCHOICE:
                EnterPcondchoice((Production) node);
                break;
            case (int) SyntaxConstants.PCREAMICE:
                EnterPcreamice((Production) node);
                break;
            case (int) SyntaxConstants.PCREAM:
                EnterPcream((Production) node);
                break;
            case (int) SyntaxConstants.PFUNCTION:
                EnterPfunction((Production) node);
                break;
            case (int) SyntaxConstants.PRETURN:
                EnterPreturn((Production) node);
                break;
            case (int) SyntaxConstants.PRET:
        ...
        public override Node Exit(Node node) {
            ...
            case (int) SyntaxConstants.PJOLLICS:
                return ExitPjollics((Production) node);
            case (int) SyntaxConstants.PGLOBAL:
            ...
            case (int) SyntaxConstants.PCTRCHOICE:
                return ExitPctrchoice((Production) node);
            case (int) SyntaxConstants.PVARDECTAIL:
                return ExitPvardectail((Production) node);
            case (int) SyntaxConstants.PVTCHOICE:
                return ExitPvtchoice((Production) node);
            case (int) SyntaxConstants.PARRAYTAIL:
            ...
            case (int) SyntaxConstants.PBODY:
                return ExitPbody((Production) node);
            case (int) SyntaxConstants.PBODYCHOICE:
                return ExitPbodychoice((Production) node);
            case (int) SyntaxConstants.PMATHCHOICE:
            ...
            case (int) SyntaxConstants.PLOGICAL1:
                return ExitPlogical1((Production) node);
            case (int) SyntaxConstants.PLOGICON:
            ...
            case (int) SyntaxConstants.PCONDCHOICE:
                return ExitPcondchoice((Production) node);
            case (int) SyntaxConstants.PCREAMICE:
        ...
        public override void Child(Production node, Node child) {
            ...
            case (int) SyntaxConstants.PCTR:
                ...
                break;
            case (int) SyntaxConstants.PCTRCHOICE:
                ChildPctrchoice(node, child);
                break;
            case (int) SyntaxConstants.PVARDECTAIL:
                ChildPvardectail(node, child);
                break;
            case (int) SyntaxConstants.PVTCHOICE:
                ChildPvtchoice(node, child);
                break;
            case (int) SyntaxConstants.PARRAYTAIL:
            ...
            case (int) SyntaxConstants.PPARAMTAIL:
                ...
                break;
            case (int) SyntaxConstants.PBODY:
                ChildPbody(node, child);
                break;
            case (int) SyntaxConstants.PBODYCHOICE:
                ChildPbodychoice(node, child);
                break;
            case (int) SyntaxConstants.PMATHCHOICE:
         ...
         * discovered errors</exception>
         */
        public virtual void EnterYum(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitYum(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPjollics(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPjollics(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPjollics(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPctrchoice(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPctrchoice(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPctrchoice(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPvtchoice(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPvtchoice(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPvtchoice(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPbody(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPbody(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPbody(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPbodychoice(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPbodychoice(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPbodychoice(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPlogical1(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPlogical1(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPlogical1(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPcondchoice(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPcondchoice(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPcondchoice(Production node, Node child) {
            node.AddChild(child);
        }
